...
//  !!: if you are having trough commenting just remove all comments then go through and comment out text that you want commented out...that's how I fixed your file
...
// !! : the win message should include the teams' names
